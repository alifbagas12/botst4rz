...
//
const BotName = 'HEIST BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = ''; // Nama Instagramlu cok
const whatsapplu = '0815-6856-137'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/HPrcNRM1x1537Ars4USA61'; // OFFICIAL GRUP LU 1
